...
const BookCard: React.FC<BookCardProps> = ({ book, compact = false }) => {
  return (
    <div className={`group relative glass-panel rounded-[20px] overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl dark:hover:shadow-[0_0_30px_rgba(111,87,255,0.3)] flex flex-col h-full ${compact ? 'min-w-[160px] w-[160px]' : 'w-full'}`}>
